...
fhandler = logging.FileHandler(filename='experiments/OneShot/CoraOneShot/Cora15b%.log', mode='a')
...
oldadj, features, labels, idx_train, idx_val, idx_test = load_data('cora')
...
for k in range(100):
            ...
            adj = adj.cuda()
            with open("experiments/OneShot/CoraOneShot/InfoCora15b%.txt", "a") as f:
                    print(f"Starting iteration - {k}",file=f)  
