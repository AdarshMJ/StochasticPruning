...
fhandler = logging.FileHandler(filename='experiments/20JANResults/Pubmed5%.log', mode='a')
...
if __name__ == "__main__":
    ...
    for p in range(50):
        ...
        adj = adj.cuda()
        with open("experiments/20JANResults/Pubmed5%.txt", "a") as f:
